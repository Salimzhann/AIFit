                ...
                VStack{
                        VStack{
                            ...
                            Text("\nТехника выполнения")
                                ...
                                .padding(.bottom,1)
                            VStack(spacing: 30){
                                Text("Возь­ми­те ган­тель и сядь­те на скамью. Под­ни­мите ее дву­мя ру­ками над го­ловой и удер­жи­вай­те на вы­тяну­тых ру­ках ров­но над ма­куш­кой. Прос­ле­дите за тем, что­бы ла­дони и лок­ти бы­ли об­ра­щены внутрь. Жес­тко уп­ри­тесь но­гами в пол, прог­ни­те спи­ну, а взгляд нап­равте впе­ред. Это Ва­ше ис­ходное по­ложе­ние.")
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 14)
                                            .stroke(Color.white, lineWidth: 1)
